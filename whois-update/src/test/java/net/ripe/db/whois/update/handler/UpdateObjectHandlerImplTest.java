...
public class UpdateObjectHandlerImplTest {
    ...
    @Mock
    DatabaseEventNotifier databaseEventNotifier;
    ...
    public void setUp() throws Exception {
        subject = new UpdateObjectHandlerImpl(rpslObjectUpdateDao, Lists.<BusinessRuleValidator>newArrayList(), dateTimeProvider, databaseEventNotifier);
    }
