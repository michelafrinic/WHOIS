...
@Immutable
public class PasswordOverrideCredential implements OverrideCredential {
    ...
    private PasswordOverrideCredential(final String value, final Set<UsernamePassword> possibleCredentials, final String remarks) {
        this.value = value;
    ...
    public boolean equals(final Object o) {
        ...
        final PasswordOverrideCredential that = (PasswordOverrideCredential) o;
    ...
    public static PasswordOverrideCredential parse(final String value) {
        ...
        return new PasswordOverrideCredential(value, Collections.unmodifiableSet(possibleCredentials), remarks);
    }
