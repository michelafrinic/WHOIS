...
interface AttributeSyntax extends Documented {
    ...
    *//*-AFRINIC-*/
    ...
    /*-AFRINIC-*/
    AttributeSyntax ASCII_SYNTAX = new AnySyntax("" +
            "A sequence of ASCII characters.");
    ...
    *//*-AFRINIC-*/
    AttributeSyntax NIC_HANDLE_SYNTAX = new AttributeSyntaxRegexp(30, Pattern.compile("(?i)^([A-Z]{2,4}([1-9][0-9]{0,4})?(-[A-Z]{2,10})?|AUTO-[1-9][0-9]*([A-Z]{2,4})?)$"), "" +
