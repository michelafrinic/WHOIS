...
public class Inet6numStatusTest {
    ...
    public void isValidOrgType() {
        ...
        //assertThat(AGGREGATED_BY_LIR.isValidOrgType(DIRECT_ASSIGNMENT), is(false));/*-AFRINIC-*/
        //assertThat(AGGREGATED_BY_LIR.isValidOrgType(NIR), is(false));/*-AFRINIC-*/
        //assertThat(AGGREGATED_BY_LIR.isValidOrgType(WHITEPAGES), is(false));/*-AFRINIC-*/
        ...
        //assertThat(ALLOCATED_BY_LIR.isValidOrgType(DIRECT_ASSIGNMENT), is(false));/*-AFRINIC-*/
        //assertThat(ALLOCATED_BY_LIR.isValidOrgType(NIR), is(false));/*-AFRINIC-*/
        //assertThat(ALLOCATED_BY_LIR.isValidOrgType(WHITEPAGES), is(false));/*-AFRINIC-*/
        ...
        //assertThat(ALLOCATED_BY_RIR.isValidOrgType(DIRECT_ASSIGNMENT), is(false));/*-AFRINIC-*/
        //assertThat(ALLOCATED_BY_RIR.isValidOrgType(NIR), is(false));/*-AFRINIC-*/
        //assertThat(ALLOCATED_BY_RIR.isValidOrgType(WHITEPAGES), is(false));/*-AFRINIC-*/
        ...
        //assertThat(ASSIGNED_ANYCAST.isValidOrgType(DIRECT_ASSIGNMENT), is(false));/*-AFRINIC-*/
        //assertThat(ASSIGNED_ANYCAST.isValidOrgType(NIR), is(false));/*-AFRINIC-*/
        //assertThat(ASSIGNED_ANYCAST.isValidOrgType(WHITEPAGES), is(false));/*-AFRINIC-*/
        ...
        //assertThat(ASSIGNED_PI.isValidOrgType(DIRECT_ASSIGNMENT), is(false));/*-AFRINIC-*/
        //assertThat(ASSIGNED_PI.isValidOrgType(NIR), is(false));/*-AFRINIC-*/
        //assertThat(ASSIGNED_PI.isValidOrgType(WHITEPAGES), is(false));/*-AFRINIC-*/
