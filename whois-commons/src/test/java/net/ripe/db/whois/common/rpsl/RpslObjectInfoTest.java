...
public class RpslObjectInfoTest {
    ...
    public void testCompareTo_different_objectType() {
        ...
        assertThat(objectTypesFromResult, contains(INETNUM, INET6NUM, AS_BLOCK, AUT_NUM, AS_SET, ROUTE, ROUTE6, ROUTE_SET, INET_RTR, FILTER_SET, PEERING_SET, RTR_SET, DOMAIN, LIMERICK, MNTNER, IRT, KEY_CERT, ORGANISATION, ROLE, PERSON));
    }
}
